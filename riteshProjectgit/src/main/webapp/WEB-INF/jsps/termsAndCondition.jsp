...
<body>
	<h2>Welcome to RAPT SOCIETY</h2>
	<p>These terms and conditions outline the rules and regulations for
		the use of RAPT SOCIETY's Website.</p>
	<br />
	<span style="text-transform: capitalize;"> RAPT SOCIETY</span> is
	located at:
	<br />
	<address>
		teachers colony , bangalore<br />karnataka - , india<br />
	</address>
	<p>By accessing this website we assume you accept these terms and
		conditions in full. Do not continue to use RAPT SOCIETY's website if
		you do not accept all of the terms and conditions stated on this page.</p>
	...
	<h2>Cookies</h2>
	<p>We employ the use of cookies. By using RAPT SOCIETY's website
		you consent to the use of cookies in accordance with RAPT SOCIETY’s
		privacy policy.</p>
	...
	<h2>License</h2>
	<p>Unless otherwise stated, RAPT SOCIETY and/or it’s licensors own
		the intellectual property rights for all material on RAPT SOCIETY. All
		intellectual property rights are reserved. You may view and/or print
		pages from http://www.RAPT.com for your own personal use subject to
		restrictions set in these terms and conditions.</p>
	<p>You must not:</p>
	<ol>
		<li>Republish material from http://www.RAPT.com</li>
		<li>Sell, rent or sub-license material from http://www.RAPT.com</li>
		<li>Reproduce, duplicate or copy material from
			http://www.RAPT.com</li>
	</ol>
	<p>Redistribute content from RAPT SOCIETY (unless content is
		specifically made for redistribution).</p>
	<h2>Hyperlinking to our Content</h2>
	<ol>
		<li>The following organizations may link to our Web site without
		...
		<li>We may consider and approve in our sole discretion other link
			...
			<ol>
				<li>commonly-known consumer and/or business information sources
					such as Chambers of Commerce, American Automobile Association, AARP
					and Consumers Union;</li>
				<li>dot.com community sites;</li>
				<li>associations or other groups representing charities,
					including charity giving sites,</li>
				<li>online directory distributors;</li>
				<li>internet portals;</li>
				<li>accounting, law and consulting firms whose primary clients
					are businesses; and</li>
	...
	<p>These organizations may link to our home page, to publications
		or to other Web site information so long as the link: (a) is not in
	...
	<p>
		...
		e-mail to <a href="mailto:raptsociety47@gmail.com"
			title="send an email to raptsociety47@gmail.com">raptsociety47@gmail.com</a>.
	...
	<p>No use of RAPT SOCIETY’s logo or other artwork will be allowed
		for linking absent a trademark license agreement.</p>
	<h2>Iframes</h2>
	<p>Without prior approval and express written permission, you may
		not create frames around our Web pages or use other techniques that
		alter in any way the visual presentation or appearance of our Web
		site.</p>
	<h2>Reservation of Rights</h2>
	<p>We reserve the right at any time and in its sole discretion to
	...
	<p>If you find any link on our Web site or any linked web site
		...
		or to respond directly to you.</p>
