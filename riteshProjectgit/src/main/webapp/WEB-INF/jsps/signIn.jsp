...
<!--//online_fonts-->
	<link href="login/css/css/style.css" rel='stylesheet' type='text/css' media="all" /><!--stylesheet-->
</head>
<body>
    ...
    <div class="tab-content">
		...
		<div id="signup-agile">   
			<form action="/createUser" method="post">
				...
				<input type="password"  placeholder="Confirm Password" onfocus="this.value = '';" onblur="if (this.value == '') {this.value = 'Confirm Password';}" required="required">
