...
<link href="/bookSchedule/css/style.css" rel="stylesheet"
	type="text/css">
<link
	href="https://code.jquery.com/ui/1.10.4/themes/ui-lightness/jquery-ui.css"
	rel="stylesheet">

<title>Rapt book demo</title>
<style>
</style>
</head>
<body>
	...
	<form id="msform" action="/formData" method="get">
		...
		<!-- fieldsets -->
		<fieldset>
			<h3 id="found" class="heading"> </h3>
			

			<h3 class="fs-subtitle">Selected Class</h3>
...
-->
			<h3 class="fs-subtitle">Selected Subject</h3>
			<ul id="listSubjects">
		...
		<fieldset>
			...
			<div id="selectCity">
				<select name="city" id="cityValue">
					<option value="Ranchi" selected selected>Ranchi</option>
				</select>
			</div>
			<input type="number" name="pin" id="pin" placeholder="Pin Code">

			<textarea name="address" id="address" placeholder="Address"></textarea>
			<input type="text" name="landmark"
				placeholder="Enter your Landmark (Optional)"> <input
				type="tel" name="phoneNo" id="phoneNo"
				placeholder="Enter your Phone number"> <input type="button"
		...
		<fieldset>
			...
			<h3 class="fs-title">We will Schedulue free Demo</h3>
