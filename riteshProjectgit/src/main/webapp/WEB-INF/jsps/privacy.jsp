...
<body>
	...
	RAPT SOCIETY is located at:
	<br />
	<address>
		RAPT SOCIETY<br />teachers colony <br />7009224712
	</address>

	<p>
		It is RAPT SOCIETY’s policy to respect your privacy regarding any
		information we may collect while operating our website. This Privacy
		Policy applies to <a href="http://www.RAPT.com">www.RAPT.com</a>
		(hereinafter, "us", "we", or "www.RAPT.com"). We respect your privacy
	...
	<p>Like most website operators, RAPT SOCIETY collects
		non-personally-identifying information of the sort that web browsers
		and servers typically make available, such as the browser type,
		language preference, referring site, and the date and time of each
		visitor request. RAPT SOCIETY’s purpose in collecting non-personally
		identifying information is to better understand how RAPT SOCIETY’s
		visitors use its website. From time to time, RAPT SOCIETY may release
		non-personally-identifying information in the aggregate, e.g., by
		publishing a report on trends in the usage of its website.</p>
	<p>RAPT SOCIETY also collects potentially personally-identifying
		information like Internet Protocol (IP) addresses for logged in users
		and for users leaving comments on http://www.RAPT.com blog posts. RAPT
		SOCIETY only discloses logged in user and commenter IP addresses under
		the same circumstances that it uses and discloses
		personally-identifying information as described below.</p>

	<h2>Gathering of Personally-Identifying Information</h2>
	<p>Certain visitors to RAPT SOCIETY’s websites choose to interact
		with RAPT SOCIETY in ways that require RAPT SOCIETY to gather
		personally-identifying information. The amount and type of information
		that RAPT SOCIETY gathers depends on the nature of the interaction.
		For example, we ask visitors who sign up for a blog at
		http://www.RAPT.com to provide a username and email address.</p>
	...
	<p>Ads appearing on our website may be delivered to users by
		...
		interest to you. This Privacy Policy covers the use of cookies by RAPT
		SOCIETY and does not cover the use of cookies by any advertisers.</p>
	...
	<p>RAPT SOCIETY may collect statistics about the behavior of
		visitors to its website. RAPT SOCIETY may display this information
		publicly or provide it to others. However, RAPT SOCIETY does not
		disclose your personally-identifying information.</p>


	<h2>Cookies</h2>
	<p>To enrich and perfect your online experience, RAPT SOCIETY uses
	...
	<p>A cookie is a string of information that a website stores on a
		...
		website each time the visitor returns. RAPT SOCIETY uses cookies to
		help RAPT SOCIETY identify and track visitors, their usage of
		http://www.RAPT.com, and their website access preferences. RAPT
		SOCIETY visitors who do not wish to have cookies placed on their
		computers should set their browsers to refuse cookies before using
		RAPT SOCIETY’s websites, with the drawback that certain features of
		RAPT SOCIETY’s websites may not function properly without the aid of
		cookies.</p>
	<p>By continuing to navigate our website without changing your
		cookie settings, you hereby acknowledge and agree to RAPT SOCIETY's
		use of cookies.</p>



	<h2>Privacy Policy Changes</h2>
	<p>Although most changes are likely to be minor, RAPT SOCIETY may
		change its Privacy Policy from time to time, and in RAPT SOCIETY’s
		sole discretion. RAPT SOCIETY encourages visitors to frequently check
		this page for any changes to its Privacy Policy. Your continued use of
	...
	<p>
		This privacy policy was created at <a
		...
		via <a href="mailto:">email</a> or <a href="tel:7009224712">phone</a>.
	</p>
